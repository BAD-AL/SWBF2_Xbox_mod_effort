...
function ScriptPostLoad()
    ...
    ctf = ObjectiveCTF:New({ teamATT = ATT, teamDEF = DEF, text = "level.geo1.objectives.ctf", hideCPs = false, multiplayerRules = true })
...
if ScriptCB_GetPlatform() == "PSP" then
    ...
    ReadDataFile("SIDE\\all.lvl","all_inf_rifleman_urban","all_inf_rocketeer","all_inf_sniper","all_inf_engineer","all_inf_officer","all_inf_wookiee","all_hero_leia","all_hover_combatspeeder")
    ReadDataFile("SIDE\\imp.lvl","imp_hover_fightertank","imp_inf_rifleman","imp_inf_rocketeer","imp_inf_engineer","imp_inf_sniper","imp_inf_officer","imp_inf_dark_trooper","imp_hero_emperor")

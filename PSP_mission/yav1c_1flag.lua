...
function ScriptInit()
    StealArtistHeap(450 * 1024)
if ScriptCB_GetPlatform() == "PSP" then
        SetPSPModelMemory(3002681)
        SetPSPClipper(1)
else
    ...
    ReadDataFile("SIDE\\rep.lvl","rep_inf_ep3_rifleman","rep_inf_ep3_rocketeer","rep_inf_ep3_engineer","rep_inf_ep3_sniper","rep_inf_ep3_officer","rep_inf_ep3_jettrooper","rep_hero_macewindu","rep_hover_fightertank")
...
if ScriptCB_GetPlatform() == "PSP" then
        SetupTeams({ 
            rep =             { team = REP, units = 10, reinforcements = 200, 
              ...
              engineer =               { "rep_inf_ep3_engineer", 2 }, 

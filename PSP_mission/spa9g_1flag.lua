...
function ScriptPostLoad()
    ...
    ctf = ObjectiveOneFlagCTF:New({ teamATT = IMP, teamDEF = ALL, textATT = "game.modes.1flag", textDEF = "game.modes.1flag2", flag = "cmn_flag", homeRegion = "home_1flag", captureRegionATT = "imp_cap_1flag", captureRegionDEF = "all_cap_1flag", capRegionDummyObjectATT = "imp_cap_marker", capRegionDummyObjectDEF = "all_cap_marker", multiplayerRules = true, hideCPs = true, AIGoalWeight = 0 })

-- missionlist.lua (PSP release)
-- decompiled by BAD_AL
--
...
gMapModes = {
	...
	{
		key = "mode_eli", showstr = "modename.name.elimination",
		descstr = "modename.description.elimination", subst = "eli",
		icon = "mode_icon_eli",
	},
	{
		key = "mode_scm", showstr = "modename.name.scm",
		descstr = "modename.description.scm", subst = "scm",
		icon = "mode_icon_sc",
	},
    {
        key= "mode_scp", showstr = "modename.name.scp",
        descstr= "modename.description.scp", subst = "scp",
        icon= "mode_icon_sc"
    },
    {
        key= "mode_dcm", showstr= "modename.name.dcm",
        descstr= "modename.description.dcm",  subst= "dcm",
        icon= "mode_icon_dc"
    },
    {
        key= "mode_dcp", showstr= "modename.name.dcp",
        descstr= "modename.description.dcp", 
        subst= "dcp", 
        icon= "mode_icon_dc"
    },
    {
        key= "mode_mcm", showstr= "modename.name.mcm",
        descstr= "modename.description.mcm", subst= "mcm",
        icon= "mode_icon_mc"
    },
    {
        key= "mode_mcp", showstr= "modename.name.mcp",
        descstr= "modename.description.mcp",  subst= "mcp",
        icon= "mode_icon_mc"
    },
    {
        key= "mode_mct", showstr= "modename.name.mcm",
        descstr= "modename.description.mcm", subst= "mct",
        icon= "mode_icon_mc"
    }
}

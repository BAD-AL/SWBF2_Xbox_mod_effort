-- ifs_freeform_init_cw.lua  (PSP)
-- Decompiled by cbadal (verified)
...
--			["star03"] = { "hot_star", "pol" },
			...
			["star07"] = { "nab", --[["geo",]] "star06", "tat" },
--			["star08"] = { "star06", "geo" },
--			["star09"] = { "tat", "geo" },
--			["star10"] = { "star12", "geo", "tat" },
--			["star11"] = { "tat", "kam" },
			["star12"] = { --[["kam",]] "nab", "kas", "tat" },
			["star13"] = { "kas", --[["kam", "fel"]] "yav", "tat" },
--			["star14"] = { "fel", "yav" },
			["star15"] = { "kas", "yav", "myg" },
--			["star16"] = { "yav", "myg" },
			["star17"] = { --[["cor", "myg", "kas", "nab"]] "myg","kas","star15","nab" },
--			["star18"] = { "cor", "myg" },
--			["star19"] = { "end_star", "star18" },
			["star20"] = { --[["star17",]] "star02" --[[, "cor"]] }
		}
...
--			["geo"] = { victory = 100, defeat = 35, turn = 10 },
			["kas"] = { victory = 60, defeat = 20, turn = 3 },
--			["kam"] = { victory = 100, defeat = 35, turn = 10 },
			["mus"] = { victory = 100, defeat = 35, turn = 10 },
			["myg"] = { victory = 60, defeat = 20, turn = 3 },
			["nab"] = { victory = 100, defeat = 35, turn = 10 },

-- PSP ifs_sp_briefing.lua
-- ...\BF2_ModTools\assets\Shell\scripts\ifs_sp_briefing.lua
-- verified 
...
ifs_sp_briefing = NewIFShellScreen {
	bAcceptIsSelect = 1,
    nologo = 1,
    bg_texture = nil, -- "single_player_campaign", --nil, -- "iface_bgmeta_space",
    movieIntro      = nil, -- WAS "ifs_sp_briefing_intro",
    movieBackground = "shell_sub_left", -- nil, --"shell_sub_left", -- WAS "ifs_sp_briefing",

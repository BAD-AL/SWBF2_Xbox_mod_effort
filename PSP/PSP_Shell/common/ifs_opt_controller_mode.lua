-- PSP ifs_opt_controller_mode.lua
--verified 
--
...
ifs_opt_contmode = NewIFShellScreen {
	...
	Enter = function (this)
		if (gPlatformStr == "PSP" ) then 
			...
			ShowHideVerticalButtons(this.buttons, ifs_opt_controlmode_vbutton_layout)
		end 
	end ,
...
if(ScriptCB_GetShellActive() and (gPlatformStr ~= "PC")) and ( gPlatformStr ~= "PSP" ) then

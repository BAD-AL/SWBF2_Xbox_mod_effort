...
if ScriptCB_GetPlatform() == "PSP" then
        SetupTeams({ 
            rep =             { team = REP, units = 10, reinforcements = 200, 
            ...
            cis =             { team = CIS, units = 10, reinforcements = 200, 
    ...
    SetMemoryPoolSize("AmmoCounter",210)
    SetMemoryPoolSize("BaseHint",250)
    SetMemoryPoolSize("EnergyBar",210)
    ...
    SetAmbientMusic(REP,0.80000001192093,"rep_cor_amb_middle",1,1)
    SetAmbientMusic(REP,0.20000000298023,"rep_cor_amb_end",2,1)
    SetAmbientMusic(CIS,1,"cis_cor_amb_start",0,1)
    SetAmbientMusic(CIS,0.80000001192093,"cis_cor_amb_middle",1,1)
    SetAmbientMusic(CIS,0.20000000298023,"cis_cor_amb_end",2,1)

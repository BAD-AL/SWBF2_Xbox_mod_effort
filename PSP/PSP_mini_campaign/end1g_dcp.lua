...
function ScriptPostLoad()
    ...
    Objective1 =
        Objective:New(
        {
            teamATT = ATT,
            teamDEF = DEF,
            popupText = "level.end1g_d.objectives.coop.detail",
        ...
        Objective1EwokKill =
            ...
            function(object)
                if GetObjectTeam(object) == DEF then
                    ...
                    if ewok_count == 60 then
                        ShowMessageText("level.end1g_d.objectives.coop.1")
                    end
                    if ewok_count == 50 then
                        ShowMessageText("level.end1g_d.objectives.coop.2")
                    end
...
function ScriptInit()
    ...
    SetTeamAggressiveness(empire, 0.69999998807907)
    SetMaxFlyHeight(43)
    ...
    SetAmbientMusic(empire, 1, "imp_end_amb_start", 0, 1)
    SetVictoryMusic(ewoks, "all_end_amb_victory")
    SetDefeatMusic(ewoks, "all_end_amb_defeat")
    SetVictoryMusic(empire, "imp_end_amb_victory")
    SetDefeatMusic(empire, "imp_end_amb_defeat")

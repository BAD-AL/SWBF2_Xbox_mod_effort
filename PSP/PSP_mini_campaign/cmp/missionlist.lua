...
gMapModes = {
    ...
    {
        key = "mode_xl",
        showstr = "modename.name.xl",
        descstr = "modename.description.xl",
        subst = "xl",
        icon = "mode_icon_XL"
    }
}

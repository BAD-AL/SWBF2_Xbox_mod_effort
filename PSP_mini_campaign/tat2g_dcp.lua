...
function ScriptPostLoad()
    ...
    Objective1 =
        Objective:New(
        {
            teamATT = ATT,
            teamDEF = DEF,
            popupText = "level.tat2g_d.objectives.coop.detail",
        ...
        Objective1JawaKill =
            ...
            function(object)
                if GetObjectTeam(object) == DEF then
                    ...
                    if jawa_count == 50 then
                        ShowMessageText("level.tat2g_d.objectives.coop.1")
                    end
                    if jawa_count == 40 then
                        ShowMessageText("level.tat2g_d.objectives.coop.2")
                    end
...
function ScriptInit()
    ...
    SetTeamName(2, "Jawas")
    SetAIDifficulty(2, -1)
    SetHeroClass(empire, "imp_hero_bobafett")
    ...
    SetAmbientMusic(jawas, 1, "all_tat_amb_start", 0, 1) -- jawas == 2
    SetAmbientMusic(empire, 1, "imp_tat_amb_start", 0, 1)
    SetVictoryMusic(jawas, "all_tat_amb_victory")
    SetDefeatMusic(jawas, "all_tat_amb_defeat")
    SetVictoryMusic(empire, "imp_tat_amb_victory")
    SetDefeatMusic(empire, "imp_tat_amb_defeat")

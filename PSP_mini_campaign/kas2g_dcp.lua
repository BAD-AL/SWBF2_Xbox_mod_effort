...
function ScriptPostLoad()
    ...
    Objective1 =
        Objective:New(
        {
            teamATT = ATT,
            teamDEF = DEF,
            popupText = "level.kas2g_d.objectives.coop.detail",
        ...
        Objective1WookieKill =
            ...
            function(object)
                if GetObjectTeam(object) == DEF then
                    ...
                    if wookie_count == 70 then
                        ShowMessageText("level.kas2g_d.objectives.coop.1")
                    end
                    if wookie_count == 60 then
                        ShowMessageText("level.kas2g_d.objectives.coop.2")
                    end
                    if wookie_count == 50 then
                        ShowMessageText("level.kas2g_d.objectives.coop.3")
                    end
                    ...
                    if wookie_count == 0 then
                        ...
                        ShowMessageText("level.kas2g_d.objectives.12")

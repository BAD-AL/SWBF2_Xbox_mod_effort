...
function ScriptInit()
    ...
    SetMemoryPoolSize("ParticleTransformer::ColorTrans", 1670)
    SetMemoryPoolSize("ParticleTransformer::SizeTransf", 1220)

    SetMemoryPoolSize("LightFlash",80)
    
    ReadDataFile("sound\\dag.lvl;dag1gcw")
    ReadDataFile(assetLocation .. "sound\\AMA.lvl;AMAgcw")
    ...
    ReadDataFile(assetLocation .. "SIDE\\imp.lvl",
                    "imp_inf_rifleman",
                    "imp_inf_rocketeer",
                    "imp_inf_engineer",
                    --"imp_inf_sniper",
    ...
    ReadDataFile(assetLocation .. "SIDE\\lsd.lvl",
                --"lsd_inf_nixon",
                --"lsd_inf_locals",
                --"lsd_inf_nixon",
                ...
                "lsd_inf_beatles") -- lsd_inf_john_lennon 
    ...
    SetTeamName(ALL, "Hippies")
    SetTeamName(IMP, "Cops")
    ...
    SetMemoryPoolSize("SoundSpaceRegion", 8)
    ...
    SetMemoryPoolSize("LightFlash", 50)

    SetSpawnDelay(10.0, 0.25)
    ReadDataFile(assetLocation .. "AMA\\AMA_purp_haze.lvl", "AMA_conquest")
    ...
    OpenAudioStream(assetLocation ..  "sound\\AMA.lvl","AMAgcw_music")
    --OpenAudioStream(assetLocation ..  "sound\\EFX.lvl","EFXcw_music")
    ...
    --------------------------------------------------------------
    -- Deathmatch style soundtrack
    SetAmbientMusic(ALL, 1.0, "trippy_soundtrack",  0,1)
    SetAmbientMusic(IMP, 1.0, "trippy_soundtrack",  0,1)

    -- Conquest style AmbientMusic setup
    --SetAmbientMusic(ALL, 0.9, "rep_kam_amb_middle", 1,1)
    --SetAmbientMusic(ALL, 0.1, "rep_kam_amb_end",    2,1)
    --SetAmbientMusic(IMP, 0.9, "cis_kam_amb_start",  0,1)
    --SetAmbientMusic(IMP, 0.9, "cis_kam_amb_middle", 1,1)

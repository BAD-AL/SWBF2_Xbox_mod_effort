...
--    KillObject("shield");
    ...
    -- hangs the loadscreen :(
    --SetClassProperty("imp_walk_atat", "Acceleraton",  1.0)
    --SetClassProperty("imp_walk_atat", "MaxSpeed",  2.0)
    --SetClassProperty("imp_walk_atat", "MaxTurnSpeed",  0.4)
    --SetClassProperty("imp_walk_atat", "StoppedTurnSpeed",  0.05)
    --SetClassProperty("imp_walk_atat", "ForwardTurnSpeed",  0.03)
    --SetClassProperty("imp_walk_atat", "TurnThreshold", 0.35)
...
--Setting up Heros--
    ...
    --SetHeroClass(IMP, "snw_inf_wampa")
    ...
    AddWalkerType(1, 1) -- We only ever have 1

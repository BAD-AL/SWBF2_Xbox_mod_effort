...
function ScriptInit()
    ...
    StealArtistHeap(3072*1024) --  visibility is still shit    
    --StealArtistHeap(3172*1024) --  visibility is still shit   
    --StealArtistHeap(3272*1024) --  visibility is still shit  
    --StealArtistHeap(3372*1024) --  visibility is still shit
    --StealArtistHeap(4072*1024)  -- visibility is still shit
    ...
    --ReadDataFile("sound\\tat.lvl;tat2gcw") -- no tank lasers sound, but 4-player loads 
    --ReadDataFile("sound\\nab.lvl;nab2gcw") -- correct sound, but 2-player no load
    -- ReadDataFile("sound\\fel.lvl;fel1gcw")-- no tank lasers sound,
    ReadDataFile("sound\\myg.lvl;myg1gcw")

    -- use the empire's stuff  
    ...
    -- 2, 4, 7,0,  1; rep,cis
    -- Just Fighter tanks & Speeder bikes
    ...
    -- Removing the lines below gets 4 player to load 

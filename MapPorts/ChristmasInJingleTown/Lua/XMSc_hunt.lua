...
function ScriptInit()
    ...
    ReadDataFile("dc:SIDE\\ewk.lvl", "ewk_inf_elf")
    ...
    SetupTeams{
        hero = {
            ...
            units = 12,
                reinforcements = -1,
                soldier = { "ewk_inf_elf",10,12},     
                engineer = { "ewk_inf_elf_builder",    2,4},  
        },
    }   

-- PSP interface_util.lua 
-- verified & decompiled by cbadal 
...
elseif (gPlatformStr == "PC") then
  ...
  gSelectedTextColor = { 138, 160, 244} -- Photoshop-safe color : yellow
...
elseif (gPlatformStr == "PSP" ) then 
	gTitleTextColor = { 246, 235, 20 }
	gTitleTextAlpha = 0.80000001192093
	gSelectedTextColor = { 138, 160, 244 }
	gSelectedTextAlpha = 0.60000002384186
	gUnselectedTextColor = { 240, 240, 240 }
	gUnselectedTextAlpha = 0.60000002384186
	gHelptextTextColor = { 240, 240, 240 }
	gHelptextTextAlpha = 0.80000001192093
	gButtonWidthPad = 100
	gButtonHeightPad = 6
	gButtonGutter = 2
	gDefaultButtonScreenRelativeY = 0.60000002384186
	gMenuButtonFont = "gamefont_small"
	gPopupTextFont = "gamefont_small"
	gPopupButtonFont = "gamefont_small"
	gListboxItemFont = "gamefont_tiny"
	gPopupWidthPad = 32
	gPopupHeightPad = 32

...
-- based on file "C:\BF2_ModTools\data\Common\scripts\game_interface.lua"
--
...
ScriptCB_DoFile("popup_prompt")          -- not in base file
ScriptCB_DoFile("fakeconsole_functions") -- not in base file
